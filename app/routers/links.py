...
def create_link(
    ...
    return service.create_link(payload, principal=principal)
...
def delete_link(
    ...
    service.delete_link(link_id, principal=principal)
...
def get_links(
    ...
    outgoing, incoming = service.get_links(entry_id, principal=principal)
...
def get_graph(
    ...
    nodes, edges = service.get_graph(entry_id, depth, principal=principal)
