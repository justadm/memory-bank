...
class MemoryQualityService:
    ...
    def assess(
        ...
        *,
        ...
        score = round(
            max(0.0, min((text_score * 0.35 + title_score * 0.15 + evidence_score * 0.25 + confidence * 0.25) * duplicate_penalty, 1.0)),
            3,
        )
        reject = "placeholder_content" in flags or score < 0.25
